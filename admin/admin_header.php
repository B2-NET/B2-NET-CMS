...
<link rel="stylesheet" href="content/themes/blue-king/blue-king/css/reset.css" type="text/css" media="screen" />
<link rel="stylesheet" href="<?php siteurl(); ?>admin/css/style.css" type="text/css" media="screen" />
...
<body>
    <header>
        <div id="logo_title">
            <div id="logo"><a href="#"><img src="%!ROOT!%/blue-king/img/logo.png" width="87px" height="87px"></a></div>
        ...
        <nav>
            <ul>
                ...
                <li><a href="javascript:void(0)">TS</a></li>
            </ul>
        </nav>
    </header>
    <div id="content">
<!----------------------------------------------->
        <section class="container">
            ...
            <div id="slides">
            <img src="%!ROOT!%/blue-king/img/slide1.jpg" alt="Some alt text">
            <img src="%!ROOT!%/blue-king/img/slide2.jpg" alt="Some alt text">
            <img src="%!ROOT!%/blue-king/img/slide3.jpg" alt="Some alt text"></div>
        </section>
